...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function setActiveBrandClass() {
      ...
      this.activeClass = "page--".concat(activeBrand.name);
    }
  }, {
    key: "handleWheel",
    ...
    value: function triggerAnimation(direction) {
      if (direction === 'down') {
        if (this.currentScreen === 0) {
          this.timeline.add(this.animateIntroOut()).add(this.animateIn(this.brandWines[this.currentScreen]));
        } else if (this.currentScreen === this.totalScreens.length) {
          this.timeline.add(this.animateOut(this.brandWines[this.currentScreen - 1])).add(this.animateFooterIn());
        } else {
          this.timeline.add(this.animateOut(this.brandWines[this.currentScreen - 1])).add(this.animateIn(this.brandWines[this.currentScreen]));
        }
      } else if (direction === 'up') {
        if (this.currentScreen === 0) {
          this.timeline.add(this.animateOut(this.brandWines[this.currentScreen])).add(this.animateIntroIn());
        } else if (this.currentScreen === this.totalScreens.length) {
          this.timeline.add(this.animateFooterOut()).add(this.animateIn(this.brandWines[this.currentScreen - 1]));
        } else {
          this.timeline.add(this.animateOut(this.brandWines[this.currentScreen])).add(this.animateIn(this.brandWines[this.currentScreen - 1]));
        }
      }
    }
  }, {
    key: "animateIntroIn",
    value: function animateIntroIn() {
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline().set(this.introSection, {
        autoAlpha: 1,
        immediateRender: false
      }).to(navigationLinks, {
        autoAlpha: 0,
        stagger: 0.1
      }, this.calcDuration(0)).to(document.body, {
        className: "page page--intro ".concat(this.activeClass)
      }, this.calcDuration(0)).to(this.introDecor, {
        autoAlpha: 1,
        scale: 1,
        duration: this.calcDuration(8)
    ...
    key: "animateIntroOut",
    value: function animateIntroOut() {
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline().to(this.introDecor, {
        autoAlpha: 0,
        scale: 1.1,
        duration: this.calcDuration(8)
      }, this.calcDuration(0)).to(this.intoLinks, {
    ...
    key: "animateFooterIn",
    value: function animateFooterIn() {
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline().to(navigationLinks, {
        autoAlpha: 0,
        stagger: 0.1
      }, this.calcDuration(1.5)).to(document.body, {
        className: "page page--footer ".concat(this.activeClass)
      }, this.calcDuration(1.5)).to(this.footerButtonsWrapper, {
        autoAlpha: 1,
        immediateRender: false
      });
    }
  }, {
    key: "animateFooterOut",
    value: function animateFooterOut() {
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline().to(this.footerButtonsWrapper, {
        autoAlpha: 0
      }, 0).to(document.body, {
        className: "page page--footer ".concat(this.activeClass)
      }, 0.5).to(navigationLinks, {
        autoAlpha: 1,
        stagger: 0.1
      }, 0.5);
    }
    ...
    key: "animateIn",
    value: function animateIn(wrapper) {
      var _this = this;

      var attribute = wrapper.getAttribute('data-brand-wine');
      var can = wrapper.querySelector('.wine__can');
      var decors = wrapper.querySelectorAll('.wine__decor');
      var type = wrapper.querySelector('.wine__type');
      var heading = wrapper.querySelector('.wine__name');
      var texts = wrapper.querySelectorAll('.wine__description');
      var features = wrapper.querySelector('.wine__features');
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
        onStart: function onStart() {
          if (document.body.clientWidth > 1060) {
            _this.changeNavigationActiveLink(navigationLinks);
          }
        }
      }).set(document.body, {
        className: "page page--".concat(attribute, " ").concat(this.activeClass)
      }, 0).set(wrapper, {
        autoAlpha: 1,
        immediateRender: false
      }, 0).to(this.logo, {
        ...
        xPercent: 0,
        autoAlpha: 0.6
      }, this.calcDuration(0)).to(can, {
        autoAlpha: 1,
        x: 0
      }, this.calcDuration(0)).to(decors, {
        autoAlpha: 1,
        y: 0
      }, this.calcDuration(0)).to(type, {
        autoAlpha: 1,
        y: 0
      }, this.calcDuration(.5)).to(heading, {
        autoAlpha: 1,
        y: 0
      }, this.calcDuration(1)).to(texts, {
        autoAlpha: 1,
        y: 0
      }, this.calcDuration(1.5)).to(features, {
        autoAlpha: 1,
        y: 0
      }, this.calcDuration(3));
    }
    ...
    key: "animateOut",
    value: function animateOut(wrapper) {
      var _this2 = this;
      ...
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
        ...
        autoAlpha: 0,
        y: -10
      }, this.calcDuration(3)).set(wrapper, {
        autoAlpha: 0,
        immediateRender: false
      });
    }
  }, {
    key: "animateSideLinksOut",
    value: function animateSideLinksOut() {
      this.sideLinks.forEach(function (sideLink, i) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(sideLink, {
          xPercent: i === 0 ? -10 : 10,
          autoAlpha: 0
        });
      });
    ...
    key: "animateNavigationIn",
    value: function animateNavigationIn() {
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(navigationLinks, {
        yPercent: 0,
        autoAlpha: 1,
        stagger: 0.1
      });
    ...
    key: "changeNavigationActiveLink",
    value: function changeNavigationActiveLink(navigationLinks) {
    ...
    value: function off() {
      ...
      allWines.forEach(function (wine) {
        ...
        var decor2 = wine.querySelector('.wine__decor--2');
        var type = wine.querySelector('.wine__type');
        var heading = wine.querySelector('.wine__name');
        var texts = wine.querySelectorAll('.wine__description');
    ...
    value: function on() {
      ...
      var allWines = document.querySelectorAll('[data-brand-wine]');
      var navigationLinks = document.querySelectorAll('[data-gsap-target-id]');
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(navigationLinks, {
        autoAlpha: 0,
        yPercent: 10
      });
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.introDecor, {
    ...
    value: function handleGlobalClick(e) {
      var link = e.target.closest('[data-brand-link]');
    ...
    key: "handleFooterButtonClick",
    value: function handleFooterButtonClick(footerButton) {
      var _this3 = this;
    ...
    key: "initBrandLinks",
    value: function initBrandLinks() {
      var unActiveBrands = brands.filter(function (brand) {
        return brand.active === false;
      });
      this.links.forEach(function (link, i) {
        var linkText = link.querySelector('[data-brand-link-text]');
        linkText.textContent = unActiveBrands[i].title;
        link.setAttribute('data-brand-link', unActiveBrands[i].name);
      });
    }
  }, {
    key: "changeActiveLink",
    value: function changeActiveLink(link) {
      var _this4 = this;

      var activeBrandAttribute = link.getAttribute('data-brand-link');
      var previousBrand = brands.find(function (item) {
        return item.active === true;
      });
      var previousBrandWrapper = document.querySelector("[data-brand=".concat(previousBrand.name, "]"));
    ...
    key: "initNavigation",
    value: function initNavigation(wrapper) {
      var currentWines = wrapper.querySelectorAll('[data-brand-wine]');
    ...
    value: function renderNavigationLinks(currentWines) {
      var content = '';

      for (var index = 0; index < currentWines.length; index++) {
        var id = currentWines[index].getAttribute('data-brand-wine');
        content += "<a href=\"#\" class=\"js-navigate bullet bullet--".concat(id, " flex items-center justify-center\" data-gsap-target-id=\"").concat(id, "\" data-index=\"").concat(index, "\">") + '<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">' + '<circle class="bullet__circle" cx="13" cy="13" r="3" />' + '<circle class="bullet__outline" cx="13" cy="13" r="12" />' + '</svg>' + '</a>';
      }
...
new App();
var stickyHeaderBar = document.querySelector('.header__bar--sticky');
...
document.querySelector('.hamburger').addEventListener('click', function (e) {
  e.preventDefault();
  if (document.body.className.includes('page--dialog')) document.body.classList.remove('page--dialog');else document.body.classList.add('page--dialog');
});
...
/***/ 0:
/*!*****************************************************************!*\
  !*** multi ./resources/js/theme.js ./resources/sass/theme.sass ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\OpenServer\domains\viavino\resources\js\theme.js */"./resources/js/theme.js");
module.exports = __webpack_require__(/*! C:\OpenServer\domains\viavino\resources\sass\theme.sass */"./resources/sass/theme.sass");
